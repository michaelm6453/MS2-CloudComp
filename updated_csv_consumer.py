...
def callback(message: pubsub_v1.subscriber.message.Message) -> None:
    ...
    print("Consumed record with values:")
    print("  Time: {}".format(message_data.get('time')))
    print("  Profile Name: {}".format(message_data.get('profileName')))
    print("  Temperature: {}".format(message_data.get('temperature')))
    print("  Humidity: {}".format(message_data.get('humidity')))
    print("  Pressure: {}".format(message_data.get('pressure')))
    print("-" * 50)
